...
#function to insert records to listbox
def list_contacts():
...
#function to view the selected record
def view_record():
...
cf_bg = 'Gray35'
rf_bg = 'Gray57'  
frame_font = ("Noto Sans CJK SC", 14)
...
left_frame.place(relx=0, relwidth=0.3, relheight=1, y=30)

center_frame = Frame(root, bg=cf_bg)
center_frame.place(relx=0.3, relwidth=0.33, relheight=1, y=30)

right_frame = Frame(root, bg=rf_bg)
right_frame.place(relx=0.63, relwidth=0.4, relheight=1, y=30)
...
search_entry = Entry(center_frame, width=17, font=("Verdana", 12), textvariable=search_strvar, fg='black').place(relx=0.13, rely=0.04)

#searchbutton
Button(center_frame, text='Search', font=frame_font, width=15, command=search).place(relx=0.13, rely=0.1)
#addRecordButton
Button(center_frame, text='Add Record', font=frame_font, width=15, command=submit_record).place(relx=0.13, rely=0.3)
#viewRecordButton
Button(center_frame, text='View Record', font=frame_font, width=15, command=view_record).place(relx=0.13, rely=0.4)
#clearFieldsButton
Button(center_frame, text='Clear Fields', font=frame_font, width=15, command=clear_fields).place(relx=0.13, rely=0.5)
#deleteRecordsButton
Button(center_frame, text='Delete Record', font=frame_font, width=15, command=delete_record).place(relx=0.13, rely=0.6)
#deleteAllRecordsButton
Button(center_frame, text='Delete All Records', font=frame_font, width=15, command=delete_all_records).place(relx=0.13, rely=0.7)
...
listbox.place(relx=0.07, rely=0.15)
